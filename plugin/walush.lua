...
L("lush", function(lush)
  ...
  walush = lush(function()
    return {
      ...
      DiffChange { fg = xres.None, bg = DiffDelete.bg.ro(50) }, -- DiffChange xxx ctermfg=0 ctermbg=5 guibg=DarkMagenta
      DiffText { fg = xres.None, bg = DiffAdd.bg.lighten(2.5) }, -- DiffText   xxx cterm=bold ctermfg=0 ctermbg=9 gui=bold guibg=Red
