...
L("lush", function(lush)
  ...
  local theme = lush(function(injected_functions)
    ...
    return {
      ...
      DapUIStopNC { fg = DiagnosticError.fg, bg = xres.bg.lighten(5) },
      DapUIStop { DapUIStopNC },
      DapUIResetNC { DapUIStopNC },
      DapUIReset { DapUIResetNC },
      DapUIPlayPauseNC { fg = GitSignsAdd.fg, bg = xres.bg.lighten(5) },
      DapUIPlayPause { DapUIPlayPauseNC },
      DapUIRestartNC { DapUIPlayPauseNC },
      DapUIRestart { DapUIRestartNC },
      DapUIStepIntoNC { fg = DiagnosticWarn.fg, bg = xres.bg.lighten(5) },
      ...
      WinBar { fg = Normal.fg, bg = xres.bg.lighten(5) },
      WinBarNC { fg = Normal.fg, bg = xres.bg.lighten(5) },
