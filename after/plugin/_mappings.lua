...
Map("n", "<M-j>", ":wincmd +<CR>", { silent = true, desc = "Increase Window (horizontal)" })
Map("n", "<M-k>", ":wincmd -<CR>", { silent = true, desc = "Decrease Window (horizontal)" })
Map("n", "<M-h>", ":wincmd <<CR>", { silent = true, desc = "Decrease Window (vertical)" })
Map("n", "<M-l>", ":wincmd ><CR>", { silent = true, desc = "Increase Window (vertical)" })
